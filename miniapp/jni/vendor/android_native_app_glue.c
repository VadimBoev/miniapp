...
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_INFO, "miniapp-core", __VA_ARGS__))
#define LOGV(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "miniapp-core", __VA_ARGS__))
